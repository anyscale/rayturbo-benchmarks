## 🔁 Ray Serve Throughput Benchmark
...
### 📊 Benchmark Results: Runtime vs OSS 

To reproduce the numbers you need to:
1. Build an image with the python requirements and environment variables - The Dockerfile is provided that works with both Anyscale Runtime and OSS Ray.
...
| Number of GPU replicas | Anyscale Runtime (req/s) | Ray OSS (req/s) | Latency (p50) Anyscale Runtime | Latency (p50) OSS | Latency (p90) Anyscale Runtime | Latency (p90) OSS | Locust users RT | Locust users OSS | 
|--------|--------------------|--------------------|--------------------|--------------------|--------------------|--------------------|--------------------|--------------------|
